...
class AddThermalWaterCanDetails extends StatefulWidget {
  const AddThermalWaterCanDetails({Key? key}) : super(key: key);

  @override
  _AddThermalWaterCanDetailsState createState() =>
      _AddThermalWaterCanDetailsState();
}

class _AddThermalWaterCanDetailsState extends State<AddThermalWaterCanDetails> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              contentPadding: const EdgeInsets.all(15),
                              labelText: "Enter Brand Name (Optional)",
